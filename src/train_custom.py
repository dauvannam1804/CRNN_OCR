...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        with open(csv_path, "a", newline="") as f:
            writer = csv.writer(f)
            writer.writerow([epoch+1, train_loss, val_loss, full_acc, char_acc])
    ...
    # Plot history at the end
    plot_training_history(csv_path, os.path.join(args.save_dir, "training_history.png"))
    logger.info(f"Training finished. Plots saved to {os.path.join(args.save_dir, 'training_history.png')}")
